...
class IBTrader:
    ...
    def place_bracket_order(self, ticker, action, quantity, take_profit_pct=None, stop_loss_pct=None):
        """
        ...
        Args:
            ...
            stop_loss_pct: % de stop loss (optionnel)
        ...
        try:
            ...
            return {
                ...
                'details': {
                    ...
                    'stop_loss': f"{stop_loss_pct}%" if stop_loss_pct else None
                }
            }
